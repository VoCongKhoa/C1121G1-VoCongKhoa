...
public class Service {
    ...
    public Service(int serviceId, String serviceCode, String serviceName, int serviceArea, double serviceCost,
                   int serviceMaxPeople, String standardRoom, String descriptionOtherConvenience, double poolArea,
                   int numberOfFloors, int rentTypeId, int serviceTypeId) {
    ...
    public Service(String serviceCode, String serviceName, int serviceArea, double serviceCost, int serviceMaxPeople,
                   ...
                   int rentTypeId, int serviceTypeId) {
        this.serviceCode = serviceCode;
        this.serviceName = serviceName;
        this.serviceArea = serviceArea;
        this.serviceCost = serviceCost;
    ...
    public Service(int serviceId, String serviceCode, String serviceName, int serviceArea, double serviceCost,
                   int serviceMaxPeople, String standardRoom, String descriptionOtherConvenience, double poolArea,
                   int numberOfFloors, int rentTypeId, String rentTypeName, double rentTypeCost, int serviceTypeId,
