...
public class UserService implements IUserService {
    ...
    public void insertUserStore(User userCreate) throws SQLException {
        iUserRepository.insertUserStore(userCreate);
    }
    ...
    @Override
    public void addUserTransaction(User user, int[] permisionArray) {
        iUserRepository.addUserTransaction(user,permisionArray);
    }
}