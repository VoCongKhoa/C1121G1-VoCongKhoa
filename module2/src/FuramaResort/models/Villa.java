...
public class Villa extends Facility{
    ...
    public Villa(String serviceName, double usableArea, double price, int maximumPerson, String rentType, String villaType, double villaPoolArea, int villaNumberFloor) {
